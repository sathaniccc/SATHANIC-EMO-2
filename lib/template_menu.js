...
async function setTemplateMenu(naze, type, m, prefix, setv, db, options = {}) {
	const hari = moment.tz('Asia/Kolkata').locale('id').format('dddd');
	const tanggal = moment.tz('Asia/Kolkata').locale('id').format('DD/MM/YYYY');
	const jam = moment.tz('Asia/Kolkata').locale('id').format('HH:mm:ss');
